...
from HiTeC.utils import drop_features, drop_incidence, valid_node_edge_mask, hyperedge_index_masking, drop_incidence_with_semantic_score,sample_subhypergraph_rw,sample_subhypergraph_swalk,sample_important_subhypergraph_swalk, select_important_nodes,drop_incidence_with_structure_score
...
def encode_subgraphs(
    ...
    """Read subgraph embeddings by indexing global node/edge embeddings."""
    ...
    for g in subgraph_list:
        ...
        n = x_global.index_select(0, node_idx)
...
def train_hitec(data, model,optimizer, model_type,params, hyperedge_index1, hyperedge_index2, subgraph1, subgraph2, num_negs):
